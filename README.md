...
## Installation
### Linux Kernel v.6.12:
Just download the archieve from this repository and unzip them:
```
git clone https://github.com/Dranevich/test_module/test_module.zip
cd Downloads
unzip my_module.zip -d ./test_module
```
